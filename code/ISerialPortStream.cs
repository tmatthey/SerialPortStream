...
namespace RJCP.IO.Ports
{
    ...
    public interface ISerialPortStream
    {
        ...
        /// <returns>An <see cref="IAsyncResult"/> object to be used with <see cref="SerialPortStream.EndRead"/>.</returns>
        ...
        /// the function will wait up to <see cref="SerialPortStream.WriteTimeout"/> milliseconds for enough
